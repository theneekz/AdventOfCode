...
const packetLength = 4; // part 1
// const packetLength = 14; // part 2

for (let i = packetLength; i <= input.length; i++) {
  const currentPacket = input.slice(i - packetLength, i);
  if (isAllUnique(currentPacket)) {
    console.log(i);
    break;
  }
}

// Determines if a string is made up of only unique characters
